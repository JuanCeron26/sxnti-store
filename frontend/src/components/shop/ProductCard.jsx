        ...
        <div className="bg-[#0d0d0d] border border-white/10 rounded-xl overflow-hidden transition-all duration-300
          ...
          <div className="relative overflow-hidden aspect-[4/3] bg-black">
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              ...
              >
                <ShoppingCart className="cursor-pointer w-4 h-4 text-white" />
              </motion.button>
              <motion.div
                whileHover={{ scale: 1.1 }}
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleAddToCart}
                className="cursor-pointer flex items-center gap-1.5 px-5 py-2 bg-red-600/20 hover:bg-red-600 border border-red-600/40 hover:border-red-500 text-red-400 hover:text-white rounded text-xs font-display tracking-wider uppercase transition-all duration-200"
                style={{ paddingLeft: '10px', paddingRight: '10px', marginRight: '10px'}}>
